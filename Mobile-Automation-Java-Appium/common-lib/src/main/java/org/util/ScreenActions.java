/*
 * This utility class provides methods for performing various actions on the screen during automated testing.
 * It includes methods for interacting with elements, handling alerts, scrolling, and verifying UI elements.
 */
package org.util;
...
public class ScreenActions {
	...
	public void verifyTextEquals(WebElement element, String expectedText, String elementName) {
		...
		SoftAssert softAssert = new SoftAssert();
		softAssert.assertEquals(actualText, expectedText, elementName + " does not match expected value: " + expectedText);
	}
	...
	/**
	 * Waits for the text content of the given WebElement to be available and returns it.
	 * Handles dynamic strings and potential StaleElementReferenceException.
	 *
