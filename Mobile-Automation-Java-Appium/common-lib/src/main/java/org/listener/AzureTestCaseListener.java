/*
 * This listener class handles various events related to test execution, such as test start, success, failure, and skipping.
 * It also manages Extent Reports generation and configuration, captures logs, and detects app crashes and server errors during test execution.
 */
