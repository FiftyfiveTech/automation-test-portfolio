...
import org.pages.about.AboutScreenAfterLogin;
...
public class AboutSectionTest extends TestBase {
	 ...
	 */
	@Test(priority = 2, description = "Verify UI of About Section at login screen for different languages.", dependsOnMethods = {
			"verifyUIofAboutAtLoginScreen"
	})
	@AzureTestCaseID(ID = {
			"5043"
	})
	 ...
	 * @throws InterruptedException If the test is interrupted during execution.
	 */
	@Test(priority = 3, description = "Verify navigation and content of Terms of Service (Account).", dependsOnMethods = {
			"verifyUIofAboutAtLoginScreenForDifferentLanguages"
	})
	@AzureTestCaseID(ID = {
			"5044"
	})
	 ...
	 * @throws InterruptedException If the test is interrupted during execution.
	 */
	@Test(priority = 4, description = "Verify navigation and content of Privacy policy (Account).", dependsOnMethods = {
			"verifyNavigationAndContentOfTOSAccountBeforeLogin"
	})
	@AzureTestCaseID(ID = {
			"5045"
	})
	 ...
	 * @throws InterruptedException If the test is interrupted during execution.
	 */
	@Test(priority = 5, description = "Verify navigation and content of Terms of Service (Organization).", dependsOnMethods = {
			"verifyNavigationAndContentOfPPAccount"
	}, alwaysRun = true)
	@AzureTestCaseID(ID = {
			"5046"
	})
	 ...
	 *
	 */
	@Test(priority = 6, description = "Verify navigation and content of Open Source Licenses.", dependsOnMethods = {
			"verifyNavigationAndContentOfTOSOrg"
	})
	@AzureTestCaseID(ID = {
			"5047"
	})
	 ...
	 * @throws InterruptedException If the test is interrupted during execution.
	 */
	@Test(priority = 7, description = "Verify localization support for TOS, Privacy Policy, and Open Source Licenses before login.", dependsOnMethods = {
			"verifyNavigationAndContentOfOpenSourceLicenses"
	})
	@AzureTestCaseID(ID = {
			"5049"
	})
	 ...
	 */
	@Test(priority = 8, description = "Verify UI of About Section after login.", dependsOnMethods = {
			"verifyLocalizationSupportForTOS_PP_OpenSrcLicenses"
	})
	@AzureTestCaseID(ID = {
			"5050"
	})
