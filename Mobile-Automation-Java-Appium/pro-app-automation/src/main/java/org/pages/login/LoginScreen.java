/*
 * This class represents the login screen of the application and provides methods to interact with its elements.
 */
...
public class LoginScreen extends ScreenActions implements Login {
	...
	public void verifyLoginWithNonRegisteredEmailAndInvalidPassword() {
		...
		String expected = ErrorMessage.AUTHORIZATION_INCORRECT_EMAIL;
