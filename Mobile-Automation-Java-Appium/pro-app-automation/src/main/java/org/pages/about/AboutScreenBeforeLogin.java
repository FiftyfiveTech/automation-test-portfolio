...

{
	...
	/*
	 * public void verifyLocalizationSupportForTOS_PP_OpenSrcLicenses() throws
	 * InterruptedException { verify(() -> { try {
	 * selectLanguageAndVerify("Français", "Conditions d'utilisation",
	 * "Terms of Service (Account)"); selectLanguageAndVerify("Français",
	 * "Politique de confidentialité", "Privacy Policy (Account)");
	 * selectLanguageAndVerify("Français",
	 * "Conditions d'utilisation (Organisation)",
	 * "Terms of Service (Organization)"); selectLanguageAndVerify("Français",
	 * "Licences Open Source", "Open Source Licenses");
	 * 
	 * selectLanguageAndVerify("Norsk", "Vilkår for tjenesten",
	 * "Terms of Service (Account)"); selectLanguageAndVerify("Norsk",
	 * "Personvernerklæring", "Privacy Policy (Account)");
	 * selectLanguageAndVerify("Norsk", "Vilkår for tjenesten (bedrift)",
	 * "Terms of Service (Organization)"); selectLanguageAndVerify("Norsk",
	 * "Åpne kildelisenser", "Open Source Licenses");
	 * 
	 * selectLanguageAndVerify("Svenska", "Användarvillkor",
	 * "Terms of Service (Account)"); selectLanguageAndVerify("Svenska",
	 * "Integritetspolicy", "Privacy Policy (Account)");
	 * selectLanguageAndVerify("Svenska", "Användarvillkor (Företag)",
	 * "Terms of Service (Organization)"); selectLanguageAndVerify("Svenska",
	 * "Öppen källkodslicenser", "Open Source Licenses");
	 * 
	 * selectLanguageAndVerify("Deutsch", "AGB", "Terms of Service (Account)");
	 * selectLanguageAndVerify("Deutsch", "Datenschutzerklärung",
	 * "Privacy Policy (Account)"); selectLanguageAndVerify("Deutsch",
	 * "AGB (Unternehmen)", "Terms of Service (Organization)");
	 * selectLanguageAndVerify("Deutsch", "Open Source Lizenz",
	 * "Open Source Licenses");
	 * 
	 * selectLanguageAndVerify("Danish", "Brugervilkår",
	 * "Terms of Service (Account)"); selectLanguageAndVerify("Danish",
	 * "Fortrolighedspolitik", "Privacy Policy (Account)");
	 * selectLanguageAndVerify("Danish", "Brugervilkår (Organisation)",
	 * "Terms of Service (Organization)"); selectLanguageAndVerify("Danish",
	 * "Open Source-licenser", "Open Source Licenses"); } catch (Exception e) {
	 * 
	 * } }); }
	 * 
	 * public void selectLanguageAndVerify(String language, String expectedTitle,
	 * String section) throws InterruptedException { languageDrpDwn.click();
	 * selectLanguage(language); Thread.sleep(1000); // Adding a delay to ensure
	 * language selection takes effect verify(() -> { verifyTopNavBarTitle(new
	 * SoftAssert(), expectedTitle, section); // Perform the corresponding action
	 * after verifying the top navigation bar title switch (section) { case
	 * "Terms of Service (Account)":
	 * waitForElementToBeClickable(tos_Account).click(); break; case
	 * "Privacy Policy (Account)":
	 * waitForElementToBeClickable(prvcyPlcy_Account).click(); break; case
	 * "Terms of Service (Organization)":
	 * waitForElementToBeClickable(tos_Org).click(); break; case
	 * "Open Source Licenses": waitForElementToBeClickable(opnsrclicenses).click();
	 * break; default: break; } // Wait for the back button to be clickable and then
	 * navigate back waitForElementToBeClickable(back_NavBtn); navigateBack(); }); }
	 * 
	 * public void verifyTopNavBarTitle(SoftAssert softAssert, String expectedTitle,
	 * String section) { switch (section) { case "Terms of Service (Account)":
	 * softAssert.assertEquals(topNavTitle.getAttribute("text"), expectedTitle,
	 * section + " top Nav Bar is not updating in " + expectedTitle + " language.");
	 * break; case "Privacy Policy (Account)":
	 * softAssert.assertEquals(topNavTitle.getAttribute("text"), expectedTitle,
	 * section + " top Nav Bar is not updating in " + expectedTitle + " language.");
	 * break; case "Terms of Service (Organization)":
	 * softAssert.assertEquals(topNavTitle.getAttribute("text"), expectedTitle,
	 * section + " top Nav Bar is not updating in " + expectedTitle + " language.");
	 * break; case "Open Source Licenses":
	 * softAssert.assertEquals(topNavTitle.getAttribute("text"), expectedTitle,
	 * section + " top Nav Bar is not updating in " + expectedTitle + " language.");
	 * break; default: break; } }
	 */
...
//		waitForElementToBeClickable(tos_Account);
//		tos_Account.click();
//		waitForElementToBeVisible(topNavTitle);
//		Assert.assertEquals(topNavTitle.getAttribute("text"), "Conditions d'utilisation",
//				"TOS (Account) top Nav Bar is not updating in French language.");
//		waitForElementToBeClickable(back_NavBtn);
//		navigateBack();
//
//		waitForElementToBeClickable(prvcyPlcy_Account);
//		prvcyPlcy_Account.click();
//		Assert.assertEquals(topNavTitle.getAttribute("text"), "Politique de confidentialité",
//				"Privacy Policy(Account) top Nav Bar is not updating in French language.");
//		waitForElementToBeClickable(back_NavBtn);
//		navigateBack();
//
//		waitForElementToBeClickable(tos_Org);
//		tos_Org.click();
//		Assert.assertEquals(topNavTitle.getAttribute("text"), "Conditions d\'utilisation (Organisation)",
//				"TOS(Organisation) top Nav Bar is not updating in French language.");
//		waitForElementToBeClickable(back_NavBtn);
//		navigateBack();
//
//		waitForElementToBeClickable(opnsrclicenses);
//		opnsrclicenses.click();
//		Assert.assertEquals(topNavTitle.getAttribute("text"), "Licences Open Source",
//				"TOS(Organisation) top Nav Bar is not updating in French language.");
//		waitForElementToBeClickable(back_NavBtn);
//		navigateBack();
//
//		// Switch to the Norsk language
//		selectLanguage("Norsk");
//
//		// Perform actions and add translated Assert compare strings for Norsk language
//		waitForElementToBeClickable(tos_Account);
//		tos_Account.click();
//		waitForElementToBeVisible(topNavTitle);
//		Assert.assertEquals(topNavTitle.getAttribute("text"), "Vilkår for tjenesten",
...
//		waitForElementToBeClickable(prvcyPlcy_Account);
//		prvcyPlcy_Account.click();
//		Assert.assertEquals(topNavTitle.getAttribute("text"), "Personvernerklæring",
...
//		waitForElementToBeClickable(tos_Org);
//		tos_Org.click();
//		Assert.assertEquals(topNavTitle.getAttribute("text"), "Vilkår for tjenesten (bedrift)",
...
//		waitForElementToBeClickable(opnsrclicenses);
//		opnsrclicenses.click();
//		Assert.assertEquals(topNavTitle.getAttribute("text"), "Åpne kildelisenser",
//				"TOS(Organisation) top Nav Bar is not updating in Norsk language.");
//		waitForElementToBeClickable(back_NavBtn);
//		navigateBack();
//
//		selectLanguage("Svenska");
//		// Perform actions and add translated Assert compare strings for Svenska
//		// language
//		waitForElementToBeClickable(tos_Account);
//		tos_Account.click();
//		waitForElementToBeVisible(topNavTitle);
//		Assert.assertEquals(topNavTitle.getAttribute("text"), "Användarvillkor",
...
//		waitForElementToBeClickable(prvcyPlcy_Account);
//		prvcyPlcy_Account.click();
//		Assert.assertEquals(topNavTitle.getAttribute("text"), "Integritetspolicy",
...
//		waitForElementToBeClickable(tos_Org);
//		tos_Org.click();
//		Assert.assertEquals(topNavTitle.getAttribute("text"), "Användarvillkor (Företag)",
...
//		waitForElementToBeClickable(opnsrclicenses);
//		opnsrclicenses.click();
//		Assert.assertEquals(topNavTitle.getAttribute("text"), "Öppen källkodslicenser",
//				"TOS(Organisation) top Nav Bar is not updating in Svenska language.");
//		waitForElementToBeClickable(back_NavBtn);
//		navigateBack();
//
...
//		waitForElementToBeClickable(tos_Account);
//		tos_Account.click();
//		Assert.assertEquals(topNavTitle.getAttribute("text"), "AGB",
...
//		waitForElementToBeClickable(prvcyPlcy_Account);
//		prvcyPlcy_Account.click();
//		Assert.assertEquals(topNavTitle.getAttribute("text"), "Datenschutzerklärung",
...
//		waitForElementToBeClickable(tos_Org);
//		tos_Org.click();
//		Assert.assertEquals(topNavTitle.getAttribute("text"), "AGB (Unternehmen)",
...
//		waitForElementToBeClickable(opnsrclicenses);
//		opnsrclicenses.click();
//		Assert.assertEquals(topNavTitle.getAttribute("text"), "Open Source Lizenz",
//				"TOS(Organisation) top Nav Bar is not updating in Deutsch language.");
//		waitForElementToBeClickable(back_NavBtn);
//		navigateBack();
//
//		selectLanguage("Danish");
//		// Perform actions and add translated Assert compare strings for Danish language
//		waitForElementToBeClickable(tos_Account);
//		tos_Account.click();
//		waitForElementToBeVisible(topNavTitle);
//		Assert.assertEquals(topNavTitle.getAttribute("text"), "Brugervilkår",
...
//		waitForElementToBeClickable(prvcyPlcy_Account);
//		prvcyPlcy_Account.click();
//		Assert.assertEquals(topNavTitle.getAttribute("text"), "Fortrolighedspolitik",
...
//		waitForElementToBeClickable(tos_Org);
//		tos_Org.click();
//		Assert.assertEquals(topNavTitle.getAttribute("text"), "Brugervilkår (Organisation)",
...
//		waitForElementToBeClickable(opnsrclicenses);
//		opnsrclicenses.click();
//		Assert.assertEquals(topNavTitle.getAttribute("text"), "Open Source-licenser",
//				"TOS(Organisation) top Nav Bar is not updating in Danish language.");
//		waitForElementToBeClickable(back_NavBtn);
//		navigateBack();
//		languageDrpDwn.click();
