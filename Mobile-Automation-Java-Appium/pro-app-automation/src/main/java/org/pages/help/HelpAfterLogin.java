...
public class HelpAfterLogin extends ScreenActions implements Help {
	 ...
	 *
	 * @param customerSupportText The text to locate and click the "Customer Support" element.
	 */
	...
	//Methods to verify FAQs
	public void verifyTextofFAQs(WebElement faqElement, WebElement faqQuestion, String FaqQuestionText,
								 String FaqQelementName, WebElement faqAnswer, String FaqAnswerTextPart, String FaqAelementName) throws InterruptedException {
	...
	public void verifyUIofHelpScreenAfterLogin() {
	...
	public void verifyNavigationAndContentOfFAQsAfterLogin() throws InterruptedException {
		...
		waitForElementToBeVisible(customerSupport);
	...
	public void verifyTextofOtherBrandFAQs(WebElement faqQuestion, String FaqQuestionText,
										   String FaqQelementName, WebElement faqAnswer, String FaqAnswerTextPart, String FaqAelementName) throws InterruptedException {
		SoftAssert softAssert = new SoftAssert();
	...
	public void verifyNavigationAndContentForFAQsOfContura() throws InterruptedException {
		verifyTextofOtherBrandFAQs(faq_ques_content, "What should I consider before lighting for the first time?", "FAQ1 question",
				faq1Ans_Ctra, "Your Contura fireplace is ", "FAQ1 answer");
		// Bug fix : APPS-2539
		...
		verifyTextofOtherBrandFAQs(faq_ques_content, "How do I light the fire?", "FAQ3 question",
				faq_Answer_Text, "the correct operating temperature in the firebox", "FAQ3 answer");
		...
		verifyTextofOtherBrandFAQs(faq_ques_content, "How damp firewood can I use?", "FAQ6 question",
				faq_Answer_Text, "About 50% of the weight of", "FAQ6 answer");
		verifyTextofOtherBrandFAQs(faq_ques_content, "What am I not allowed to burn?", "FAQ7 question",
				faq_Answer_Text, "Under no circumstances may fossil fuels", "FAQ7 answer");
		...
		verifyTextofOtherBrandFAQs(faq_ques_content, "How to clean the glass?", "FAQ9 question",
				faq_Answer_Text, "Soot may form on the glass", "FAQ9 answer");
		verifyTextofOtherBrandFAQs(faq_ques_content, "How do I empty the ash-pan?", "FAQ10 question",
				faq_Answer_Text, "When emptying the ash-pan", "FAQ10 answer");
		...
		verifyTextofOtherBrandFAQs(faq_ques_content, "How to clean the stove?", "FAQ12 question",
				faq_Answer_Text, "Use a wire brush to clean", "FAQ12 answer");
		verifyTextofOtherBrandFAQs(faq_ques_content, "Where do I turn if I need new parts/spare parts?", "FAQ13 question",
				faq_Answer_Text, "Parts located near the actual", "FAQ13 answer");
		verifyTextofOtherBrandFAQs(faq_ques_content, "Why is difficult to light the fire and the fire dies after a short time?", "FAQ14 question",
				faq_Answer_Text, "Check that the wood is sufficiently dry", "FAQ14 answer");
		verifyTextofOtherBrandFAQs(faq_ques_content, "Why do I experience excessive amounts on the glass?", "FAQ15 question",
				faq_Answer_Text, "There is always some soot on the glass", "FAQ15 answer");
		verifyTextofOtherBrandFAQs(faq_ques_content, "Why do I get occasional smell of smoke around the fireplace?", "FAQ16 question",
				faq_Answer_Text, "This can occur when wind blows down the chimney", "FAQ16 answer");
		...
		verifyTextofOtherBrandFAQs(faq_ques_content, "What status messages can I expect from the app:", "FAQ19 question",
				faq_Answer_Text, "Temp to high in stove.", "FAQ19 answer");
		verifyTextofOtherBrandFAQs(faq_ques_content, "What do the different colors of LED mean in the button?", "FAQ20 question",
				faq_Answer_Text, "LED off:", "FAQ20 answer");
		verifyTextofOtherBrandFAQs(faq_ques_content, "What is a connection string?", "FAQ21 question",
				faq_Answer_Text, "A connection string is a code", "FAQ21 answer");
		verifyTextofOtherBrandFAQs(faq_ques_content, "Wifi pairing problem?", "FAQ21 question",
				faq_Answer_Text, "The wifi-modul only support", "FAQ22 answer");
		verifyTextofOtherBrandFAQs(faq_ques_content, "What are the requirements on my internet connection?", "FAQ22 question",
				faq_Answer_Text, "The speed of the connection has no", "FAQ23 answer");
		...
		verifyTextofOtherBrandFAQs(faq_ques_content, "My system cannot connect to the internet, what can I do?", "FAQ25 question",
				faq_Answer_Text, "Make sure wifi is enabled on the system", "FAQ26 answer");
	...
	public void verifyNavigationAndContentForFAQsOfConturaInSvenska() throws InterruptedException {
		verifyTextofOtherBrandFAQs(faq_ques_content, "Vad bör jag tänka på innan jag tänder för första gången?", "FAQ1 question",
				faq1Ans_Ctra, "Din Contura eldstad är avsedd att användas som en sekundär värmekälla", "FAQ1 answer");
		// Bug fix : APPS-2539
		...
		verifyTextofOtherBrandFAQs(faq_ques_content, "Hur gör jag en upptändning?", "FAQ3 question",
				faq_Answer_Text, "Var uppmärksam på att om", "FAQ3 answer");
		...
		verifyTextofOtherBrandFAQs(faq_ques_content, "Vad får jag inte elda?", "FAQ7 question",
				faq_Answer_Text, "Man får absolut inte", "FAQ7 answer");
		...
		verifyTextofOtherBrandFAQs(faq_ques_content, "Hur rengör man glaset?", "FAQ9 question",
				faq_Answer_Text, "Vid eldning kan glasen bli sotiga", "FAQ9 answer");
		verifyTextofOtherBrandFAQs(faq_ques_content, "Hur tömmer jag asklådan?", "FAQ10 question",
				faq_Answer_Text, "När du tömmer asklådan, se till", "FAQ10 answer");
		...
		verifyTextofOtherBrandFAQs(faq_ques_content, "Hur rengör man kaminen?", "FAQ12 question",
				faq_Answer_Text, "Använd en stålborste för", "FAQ12 answer");
		verifyTextofOtherBrandFAQs(faq_ques_content, "Vart vänder jag mig om jag behöver reservdelar?", "FAQ13 question",
				faq_Answer_Text, "Detaljer som sitter nära själva", "FAQ13 answer");
		verifyTextofOtherBrandFAQs(faq_ques_content, "Varför är det svårt att tända brasan och elden dör ut efter en kortare tid?", "FAQ14 question",
				faq_Answer_Text, "Kontrollera att veden är tillräckligt torr", "FAQ14 answer");
		verifyTextofOtherBrandFAQs(faq_ques_content, "Varför upplever jag för onormalt mycket sot på glasen?", "FAQ15 question",
				faq_Answer_Text, "Det blir alltid en viss sotbeläggning", "FAQ15 answer");
		...
		verifyTextofOtherBrandFAQs(faq_ques_content, "Varför låter kaminen ibland?", "FAQ17 question",
				faq_Answer_Text, "När luckan öppnas efter att", "FAQ17 answer");
		...
		verifyTextofOtherBrandFAQs(faq_ques_content, "Vilka statusmeddelanden kan jag förvänta mig från appen?", "FAQ19 question",
				faq_Answer_Text, "Temperatur för hög i kaminen", "FAQ19 answer");
		...
		verifyTextofOtherBrandFAQs(faq_ques_content, "Vad är en anslutningssträng?", "FAQ21 question",
				faq_Answer_Text, "En anslutningssträng", "FAQ21 answer");
		verifyTextofOtherBrandFAQs(faq_ques_content, "Wifi anslutningsproblem?", "FAQ21 question",
				faq_Answer_Text, "Wifi modulen stödjer", "FAQ22 answer");
		...
		verifyTextofOtherBrandFAQs(faq_ques_content, "Vad ska jag göra om min anläggning inte kan ansluta till internet?", "FAQ25 question",
				faq_Answer_Text, "Kontrollera att wifi är aktiverat", "FAQ26 answer");
		verifyTextofOtherBrandFAQs(faq_ques_content, "Vad händer vid larm?", "FAQ26 question",
				faq_Answer_Text, "Vid larm skickas såväl", "FAQ27 answer");
		...
		verifyTextofOtherBrandFAQs(faq_ques_content, "Hur många anläggningar kan en användare vara ansluten till?", "FAQ28 question",
				faq_Answer_Text, "Det finns ingen övre gräns", "FAQ29 answer");
		verifyTextofOtherBrandFAQs(faq_ques_content, "Kan ni övervaka och administrera min anläggning?", "FAQ29 question",
				faq_Answer_Text, "I dagsläget erbjuder vi inte", "FAQ30 answer");
		verifyTextofOtherBrandFAQs(faq_ques_content, "Vad rekommenderar ni för att skydda min myUplink-produkt och mitt konto från att bli hackad?", "FAQ30 question",
				faq_Answer_Text, "Vi arbetar kontinuerligt med", "FAQ31 answer");
